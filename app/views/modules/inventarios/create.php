...
<!-- Choices CSS -->
<link rel="stylesheet" href="<?= VENDOR_URL; ?>choices/css/choices-bootstrap.css">
<!-- Choices JS -->
<script src="<?= VENDOR_URL; ?>choices/js/choices.min.js"></script>

<div class="container">

    <div class="card my-5 col-12 col-md-10 col-lg-8 col-xl-6 m-auto animate__animated animate__fadeIn">
        ...
        <form action="<?= APP_URL; ?>inventarios/nuevo" method="POST" class="m-0">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <select type="producto_id" class="form-select" id="producto_id" autofocus data-placeholder="Elegir Producto para realizar el inventario">
                ...
                <!-- <div class="mb-3">
                    <label for="producto_id" class="form-label">Productos</label>
                    <input type="text" class="form-control text-primary" name="usuario" id="usuario" list="lista-productos" autocomplete="off">
                ...
                <div class="row g-3">
                    ...
                    <div class="mb-3 col-12 col-md-6">
                        ...
                        <input type="date" class="form-control text-center" name="fecha_vencimiento" id="fecha_vencimiento" value="<?= Helpers::getCurrentDateISO(); ?>" required>
                    </div>
                </div>
...
<script>
    // Pass single element
    const element = document.querySelector('#producto_id');
